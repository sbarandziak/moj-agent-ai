...
//
// Wszystkie grupy mają własną ikonę — żadna nie chowa się pod „Więcej".
// Za mieszczenie się railu odpowiadają media queries przy .rail-btn.
// ============================================================
...
export default function Nav() {
  ...
  // pointerdown, nie mousedown: iOS emuluje zdarzenia myszy tylko na
  // elementach „klikalnych", więc tapnięcie w zwykłą treść nie zamykałoby menu.
  useEffect(() => {
    if (!open) return;
